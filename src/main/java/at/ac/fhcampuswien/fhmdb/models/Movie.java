...
public class Movie {
    ...
    public static List<Movie> initializeMovies() {
        ...
        movies.add(new Movie("Pulp Fiction", "The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.", Arrays.asList(Genre.COMEDY, Genre.ADVENTURE, Genre.CRIME, Genre.THRILLER), 1994, 9.9));
        movies.add(new Movie("No Country For Old Men", "When a man stumbles upon a drug deal gone wrong and a case full of money, he sets off a chain of events that leads to relentless pursuit by a ruthless killer.", Arrays.asList(Genre.THRILLER, Genre.WESTERN, Genre.ACTION, Genre.CRIME), 2007, 9.3));
        movies.add(new Movie("Inglourious Basterds", "The film tells the fictional alternate history tale of the unwitting convergence of two independent plots to assassinate Nazi Germany's political leadership.", Arrays.asList(Genre.HISTORY, Genre.COMEDY, Genre.WAR, Genre.ACTION), 2009, 8.4));
        movies.add(new Movie("Django Unchained", "A slave named Django who teams up with a German bounty hunter to rescue his wife from a cruel plantation owner.", Arrays.asList(Genre.WESTERN, Genre.ADVENTURE, Genre.COMEDY, Genre.ACTION), 2012, 9.5));
        movies.add(new Movie("Shrek", "It's the story of a terrifying green ogre by the name of Shrek, who lives in a swamp.", Arrays.asList(Genre.ANIMATION, Genre.ADVENTURE, Genre.COMEDY, Genre.ROMANCE), 2001, 9.0));
        movies.add(new Movie("The SpongeBob SquarePants Movie", "SpongeBob takes leave from Bikini Bottom in order to track down, with Patrick, King Neptune's stolen crown.", Arrays.asList(Genre.ANIMATION, Genre.ADVENTURE, Genre.COMEDY, Genre.FAMILY), 2004, 10.0));
        movies.add(new Movie("John Wick", "A retired assassin who returns back to his old ways after a group of Russian gangsters steal his car and kill his puppy.", Arrays.asList(Genre.DRAMA, Genre.ACTION, Genre.CRIME, Genre.COMEDY), 2014, 7.9));
